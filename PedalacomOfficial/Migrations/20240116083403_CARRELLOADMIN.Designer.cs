...
namespace PedalacomOfficial.Migrations
{
    ...
    [Migration("20240116083403_CARRELLOADMIN")]
    partial class CARRELLOADMIN
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pedalacom.ShoppingCart.Models.CartItem", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.LogError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("Pedalacom.ShoppingCart.Models.CartItem", b =>
                {
                    b.HasOne("PedalacomOfficial.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PedalacomOfficial.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.CustomerAddress", b =>
                {
                    b.HasOne("PedalacomOfficial.Models.Address", "Address")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.Product", b =>
                {
                    b.HasOne("PedalacomOfficial.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("PedalacomOfficial.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.ProductCategory", b =>
                {
                    b.HasOne("PedalacomOfficial.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("PedalacomOfficial.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.SalesOrderDetail", b =>
                {
                    ...
                    b.HasOne("PedalacomOfficial.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("PedalacomOfficial.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("PedalacomOfficial.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("PedalacomOfficial.Models.Address", "ShipToAddress")
